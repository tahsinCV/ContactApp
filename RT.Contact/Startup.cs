...
namespace RT.Contacts
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserInformation, UserInformationService>();
            services.AddScoped<ICity, CityService>();
            services.AddScoped<ICityBL, CityBL>();
            services.AddScoped<IUserInformationBL, UserInformationBL>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RT.Contact v1"));
            }
